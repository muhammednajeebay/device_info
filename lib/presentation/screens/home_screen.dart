      ...
      body: Container(
        ...
        child: const SafeArea(
          child: CustomScrollView(
            ...
            slivers: [
              _HomeHeader(),
              _SystemHealthRingSection(),
              _QuickStatsGridSection(),
              _DetailedAnalysisTitleSection(),
              _DetailedAnalysisListSection(),
            ],
          ),
        ),
      ),
            ...
            Column(
              ...
              children: [
                ...
                BlocBuilder<DeviceBloc, DeviceState>(
                  buildWhen: (previous, current) => current is DeviceLoaded,
                  builder: (context, state) {
                    return Text(
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => HomeScreen._showSettingsModal(context),
                ),
              ],
            ),
          ],
...
class _SystemHealthRingSection extends StatelessWidget {
  const _SystemHealthRingSection();
        ...
        child: Padding(
          ...
          child: BlocBuilder<BatteryBloc, BatteryState>(
            builder: (context, state) {
              ...
              return HealthRing(value: batteryLevel, label: 'SYSTEM HEALTH');
            },
          ),
        ),
      ),
...
class _QuickStatsGridSection extends StatelessWidget {
  const _QuickStatsGridSection();
            ...
            child: BlocBuilder<BatteryBloc, BatteryState>(
              builder: (context, state) => QuickStatWidget(
                ...
                value: state is BatteryLoaded
                    ...
                    : '...',
                subLabel: state is BatteryLoaded && state.batteryInfo.isCharging
                    ? 'Charging'
                    : 'Discharging',
...
class _DetailedAnalysisTitleSection extends StatelessWidget {
  const _DetailedAnalysisTitleSection();
...
class _DetailedAnalysisListSection extends StatelessWidget {
  const _DetailedAnalysisListSection();
      ...
      sliver: SliverList(
        delegate: SliverChildListDelegate([
          BlocBuilder<BatteryBloc, BatteryState>(
            builder: (context, state) => CategoryCard(
              ...
              value: state is BatteryLoaded
                  ? '${state.batteryInfo.level}%'
                  : '...',
              subtitle: state is BatteryLoaded && state.batteryInfo.isCharging
                  ? 'Charging'
                  : 'Optimized',
              icon: Icons.bolt_rounded,
              color: CategoryColors.battery,
          ...
          BlocBuilder<DeviceBloc, DeviceState>(
            builder: (context, state) => CategoryCard(
              title: 'Device',
              value: state is DeviceLoaded ? state.deviceInfo.model : '...',
          ...
          BlocBuilder<ConnectivityBloc, ConnectivityState>(
            builder: (context, state) => CategoryCard(
              ...
              onTap: () => Navigator.push(
                context,
                ModernPageRoute(page: const ConnectivityDetailScreen()),
              ),
            ),
          ),
